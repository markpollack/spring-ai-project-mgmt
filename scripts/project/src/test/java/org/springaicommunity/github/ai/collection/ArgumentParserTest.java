...
/**
 * Tests for ArgumentParser using plain JUnit only.
...
class ArgumentParserTest {
    ...
    class RepositoryValidationTest {
        ...
        @ParameterizedTest
        @ValueSource(strings = {"spring-projects/spring-ai", "microsoft/vscode", "kubernetes/kubernetes", "user123/repo-name", "org_name/repo.name"})
        ...
        void shouldRejectInvalidRepositoryFormats(String invalidRepo) {
            ...
            assertThatThrownBy(() -> argumentParser.parseAndValidate(args))
    ...
    class IssueStateFilteringTest {
        ...
        void shouldRejectInvalidIssueStates(String invalidState) {
            ...
            assertThatThrownBy(() -> argumentParser.parseAndValidate(args))
                .isInstanceOf(IllegalArgumentException.class)
                .hasMessageContaining("Invalid state '" + invalidState.toLowerCase() + "': must be 'open', 'closed', or 'all'");
        }
    }
    ...
    class HelpTextGenerationTest {
        ...
        void shouldGenerateHelpTextWithDefaultValues() {
            ...
            assertThat(helpText)
                .contains("Usage: collect_github_issues.java [OPTIONS]")
    ...
    class EnvironmentValidationTest {
        ...
        void shouldPassValidationWhenGitHubTokenIsSet() {
            ...
            assertThatCode(() -> argumentParser.validateEnvironment())
                .doesNotThrowAnyException();
        }
        ...
        void environmentValidationBehaviorIsDocumented() {
            ...
            // We can't easily test the failure case without modifying environment variables.
