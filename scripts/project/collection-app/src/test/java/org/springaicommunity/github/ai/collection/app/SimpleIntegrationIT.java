 ...
 * 
 * These tests verify basic functionality without strict expectations:
 * 1. GitHub API connectivity works
 * 2. Basic issue collection completes without errors
 * 3. Services can handle real API responses
 * 
...
class SimpleIntegrationIT {
    ...
    void basicQueryBuildingTest() {
        ...
        assertThatCode(() -> {
            String query = restService.buildSearchQuery(
                "spring-projects", "spring-ai", "closed", List.of(), "any");
    ...
    void zeroResultsHandlingTest() throws Exception {
        ...
        CollectionRequest request = new CollectionRequest(
            "spring-projects/spring-ai", 3, false, false, false, true, false,
            "open", List.of("impossible-nonexistent-label-12345"), "any"
        );
