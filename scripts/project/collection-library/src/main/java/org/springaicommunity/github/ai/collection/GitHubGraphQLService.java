...
public class GitHubGraphQLService {
     ...
     * @param sortBy Sort field (updated/created/comments/reactions) - converted to GraphQL format
     ...
     */
    public JsonNode searchIssuesWithSorting(String searchQuery, String sortBy, String sortOrder, int first, String after) {
        ...
        Object variables = Map.of(
            "query", buildSortedSearchQuery(searchQuery, sortParam, orderParam),
            "first", first,
    ...
    /**
     * Convert REST API sort parameter to GraphQL search query format
     * GitHub Search API sorting is done via query qualifiers, not GraphQL orderBy
     */
