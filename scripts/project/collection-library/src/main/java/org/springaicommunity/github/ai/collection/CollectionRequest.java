 ...
 * 
 * Enhanced to support dashboard and UI use cases that require limited, 
 * sorted, and filtered issue collections.
 */
public record CollectionRequest(
    ...
    public CollectionRequest(
        ...
        this(repository, batchSize, dryRun, incremental, zip, clean, resume,
     ...
     */
    public static CollectionRequest forDashboard(
            String repository,
            String issueState,
            int maxIssues,
            String sortBy
        ...
        return new CollectionRequest(
            repository,
            Math.min(maxIssues, 100), // batch size <= maxIssues
            false,                    // dryRun
            false,                    // incremental
            false,                    // zip
            true,                     // clean
