...
public class ArgumentParser {
            ...
            switch (arg) {
                ...
                case "-b", "--batch-size":
                    ...
                    try {
                        ...
                        throw new IllegalArgumentException("Invalid batch size '" + batchSizeStr + "': must be a positive integer");
                    }
                    i++; // Skip next argument since we consumed it
                    break;
                ...
                case "-s", "--state":
                    ...
                    if (!List.of("open", "closed", "all").contains(state)) {
                        throw new IllegalArgumentException("Invalid state '" + state + "': must be 'open', 'closed', or 'all'");
                    }
                ...
                case "--label-mode":
                    ...
                    if (!List.of("any", "all").contains(labelMode)) {
                        throw new IllegalArgumentException("Invalid label mode '" + labelMode + "': must be 'any' or 'all'");
                    }
    ...
    public String generateHelpText() {
        ...
        help.append("    -r, --repo REPO         Repository in format owner/repo (default: ").append(defaultProperties.getDefaultRepository()).append(")\n");
        help.append("    -b, --batch-size SIZE   Issues per batch file (default: ").append(defaultProperties.getBatchSize()).append(")\n");
        ...
        help.append("    -s, --state <state>     Issue state: open, closed, all (default: ").append(defaultProperties.getDefaultState()).append(")\n");
    ...
    public void validateEnvironment() {
        ...
        if (githubToken == null || githubToken.trim().isEmpty()) {
            throw new IllegalStateException("GITHUB_TOKEN environment variable is required. Please set your GitHub personal access token: export GITHUB_TOKEN=your_token_here");
        }
    }
