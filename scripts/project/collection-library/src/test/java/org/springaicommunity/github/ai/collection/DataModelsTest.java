...
class DataModelsTest {
    ...
    class CollectionConfigurationTest {
        ...
        void shouldCreateCollectionMetadata() {
            ...
            CollectionMetadata metadata = new CollectionMetadata(
                timestamp, repository, totalIssues, processedIssues, batchSize, zipped
            );
        ...
        void shouldCreateCollectionRequest() {
            ...
            CollectionRequest request = new CollectionRequest(
                repository, batchSize, dryRun, incremental, zip, clean,
        ...
        void shouldCreateCollectionResult() {
            ...
            CollectionResult result = new CollectionResult(
                totalIssues, processedIssues, outputDirectory, batchFiles
            );
    ...
    class InternalProcessingTest {
        ...
        void shouldCreateBatchData() {
            ...
            int batchNumber = 5;
            Issue issue = new Issue(
                123, "Test", "Body", "closed", LocalDateTime.now(),
                LocalDateTime.now(), LocalDateTime.now(), "url",
                new Author("user", "User"), List.of(), List.of()
            );
        ...
        void shouldCreateResumeState() {
            ...
            ResumeState resumeState = new ResumeState(
                cursor, batchNumber, processedIssues, timestamp, completedBatches
            );
    ...
    class JsonSerializationTest {
        ...
        void shouldSerializeDeserializeCollectionRequest() throws JsonProcessingException {
            // Given
            CollectionRequest original = new CollectionRequest(
                "spring-projects/spring-ai", 100, true, false, true, true,
                false, "closed", Arrays.asList("bug", "enhancement"), "any"
            );
        ...
        void shouldHandleNullValuesInIssue() throws JsonProcessingException {
            ...
            Issue original = new Issue(
                123, "Test Issue", null, "open", LocalDateTime.now(),
                LocalDateTime.now(), null, "url",
                new Author("user", null), List.of(), List.of()
            );
    ...
    class RecordEqualityTest {
        ...
        void shouldDemonstrateRecordReferenceBehavior() {
            ...
            CollectionRequest request = new CollectionRequest(
                "repo", 100, false, false, false, true,
                false, "open", mutableLabels, "any"
            );
            ...
            CollectionRequest safeRequest = new CollectionRequest(
                "repo", 100, false, false, false, true,
                false, "open", immutableLabels, "any"
            );
