# Conflict Resolution Plan for PR #3914

Generated: 2025-08-05 18:54:29
...
- 🔴 COMPLEX: auto-configurations/mcp/spring-ai-autoconfigure-mcp-server/src/main/java/org/springframework/ai/mcp/server/autoconfigure/McpServerAutoConfiguration.java (Java source) - 3 conflict marker(s)
...
./pr-prepare.sh --call-claude 3914

# Or manually review each conflict:


git diff HEAD auto-configurations/mcp/spring-ai-autoconfigure-mcp-server/src/main/java/org/springframework/ai/mcp/server/autoconfigure/McpServerAutoConfiguration.java  # Review Java conflicts in auto-configurations/mcp/spring-ai-autoconfigure-mcp-server/src/main/java/org/springframework/ai/mcp/server/autoconfigure/McpServerAutoConfiguration.java
...
export PR_NUMBER=3914
claude "I have merge conflicts in PR #3914. Please analyze the conflicts and suggest resolutions. The conflicts are in: auto-configurations/mcp/spring-ai-autoconfigure-mcp-server/src/main/java/org/springframework/ai/mcp/server/autoconfigure/McpServerAutoConfiguration.java "
```
